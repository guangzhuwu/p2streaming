...
size_t malloc_usable_size(void const *);
...
#endif
#include "p2engine/nedmalloc/malloc.c.h"
#ifdef NDEBUG               /* Disable assert checking on release builds */
 #undef DEBUG
#endif
...
#define THREADCACHEMAX 8192
 ...
 #ifdef __GNUC__
  #warning If you are changing THREADCACHEMAX, do you also need to change THREADCACHEMAXBINS=(top2stpos(THREADCACHEMAX)-4)?
 #elif defined(_MSC_VER)
  #pragma message(__FILE__ ": WARNING: If you are changing THREADCACHEMAX, do you also need to change THREADCACHEMAXBINS=(top2stpos(THREADCACHEMAX)-4)?")
 #endif
#endif
...
#if 0
/* The number of cache entries for finer grained bins. This is (top2stpos(THREADCACHEMAX)-4)*2 */
#define THREADCACHEMAXBINS ((13-4)*2)
#else
/* The number of cache entries. This is (top2stpos(THREADCACHEMAX)-4) */
...
size_t (*sysblksize)(void *)=
	...
	(size_t (*)(void *))malloc_usable_size;
#elif defined(__APPLE__)
...
{	/* 8=1000	16=10000	20=10100	24=11000	32=100000	48=110000	4096=1000000000000 */
	unsigned int top2st, size=(unsigned int)(_size>>4);
	/* 16=1		20=1	24=1	32=10	48=11	64=100	96=110	128=1000	4096=100000000 */

#if defined(__GNUC__)
        top2st = sizeof(size)*__CHAR_BIT__ - 1 - __builtin_clz(size);
	...
	top2st = (asInt[!FOX_BIGENDIAN] >> 20) - 1023;
#else
	{
		unsigned int x=size;
		x = x | (x >> 1);
