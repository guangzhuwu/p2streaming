...
namespace p2engine { namespace http {
	...
	http_connection_dispatcher::received_request_handler_type http_connection_dispatcher::s_request_handler_;
	http_connection_dispatcher::received_response_handler_type http_connection_dispatcher::s_response_handler_;
