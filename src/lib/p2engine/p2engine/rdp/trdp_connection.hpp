...
namespace p2engine{ namespace trdp{
	...
	protected:
		...
		virtual ~basic_trdp_connection() {__close(true);}
	...
	protected:
		...
		virtual void on_received(const safe_buffer& buf)
		{
