...
namespace p2engine
{
	typedef p2engine::variant_stream<p2engine::socket_type, p2engine::ssl_stream<p2engine::socket_type> >
		variant_tcp_socket;
	typedef p2engine::socket_type tcp_socket;
	typedef p2engine::proxy_settings proxy_settings;

	using  p2engine::instantiate_connection;
	using  p2engine::print_endpoint;
}
