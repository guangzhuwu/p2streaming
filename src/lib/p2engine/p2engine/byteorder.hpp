...
namespace p2engine {
	...
	template<typename T>
	struct hton_with_n_bytes<T, static_cast<size_t>(2)>
	{
	public:
	...
	template<typename T>
	struct hton_with_n_bytes<T, static_cast<size_t>(4)>
	{
	public:
	...
	template<typename T>
	struct hton_with_n_bytes<T, static_cast<size_t>(8)>
	{
	public:
	...
	template<typename T>
	struct bswap_with_n_bytes<T, static_cast<size_t>(2)>
	{
	public:
	...
	template<typename T>
	struct bswap_with_n_bytes<T, static_cast<size_t>(4)>
	{
	public:
	...
	template<typename T>
	struct bswap_with_n_bytes<T, static_cast<size_t>(8)>
	{
	public:
