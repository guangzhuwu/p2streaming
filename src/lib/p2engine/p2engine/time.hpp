...
namespace p2engine{
	...
	private:
		static const uint64_t s_rough_local_tick_count;
		static const uint64_t s_precise_local_tick_count;
		static const ptime s_local_time_stamp;
		static const ptime s_universal_time_stamp;

		static const ptime& local_time_stamp()
		{
			return s_local_time_stamp;
		}
		static const ptime& universal_time_stamp()
		{
			return s_universal_time_stamp;
		}
		static int64_t elapse()
		{
			return rough_local_tick_count() - s_rough_local_tick_count;
		}
		static uint64_t precise_elapse()
		{
			return precise_local_tick_count() - s_precise_local_tick_count;
		}
	};
