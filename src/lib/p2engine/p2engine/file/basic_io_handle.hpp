...
namespace p2engine{
	...
	public:
			...
			: boost::asio::basic_io_object<HandleService>(io_service)
		{
			...
			this->get_service().assign(this->implementation, handle, ec);
		...
		boost::system::error_code assign(const native_handle_type& handle, 
			boost::system::error_code& ec)
		{
			return this->get_service().assign(this->implementation, handle, ec);
		}
		...
		{
			boost::system::error_code ec;
			this->get_service().close(this->implementation, ec);
		...
		{
			boost::system::error_code ec;
			this->get_service().cancel(this->implementation, ec);
			boost::asio::detail::throw_error(ec, "cancel");
		}

		boost::system::error_code cancel(boost::system::error_code& ec)
		{
			return this->get_service().cancel(this->implementation, ec);
		}
