...
//atom
HTTP_ATOM(HTTP_ATOM_Accept,                    "Accept");
HTTP_ATOM(HTTP_ATOM_Accept_Charset,            "Accept-Charset");
HTTP_ATOM(HTTP_ATOM_Accept_Encoding,           "Accept-Encoding");
HTTP_ATOM(HTTP_ATOM_Accept_Language,           "Accept-Language");
HTTP_ATOM(HTTP_ATOM_Accept_Ranges,             "Accept-Ranges");
